...
import { getAllCategories } from '../data/photos';
...
const HomePage: React.FC = () => {
  ...
  const handleCreateCategory = async (data: CreateCategoryData) => {
    try {
      await uploadService.createCategory(data);
            ...
            <div className="flex items-center justify-center space-x-12 mb-8">
              ...
              >
                <div className="text-3xl font-bold text-warm-800 mb-2">
                  {categories.reduce((total, category) => total + category.totalCount, 0)}
                </div>
              ...
              <motion.div 
                ...
                className="text-center bg-white/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-warm-200/50"
              >
                <div className="text-3xl font-bold text-warm-800 mb-2">{categories.length}</div>
