...
const Lightbox: React.FC<LightboxProps> = ({
  ...
  const handleDownload = () => {
    if (currentPhoto) {
      ...
      link.href = apiService.getImageUrl(currentPhoto.url);
        ...
        >
          ...
          <div className="absolute top-6 right-6 z-10 flex space-x-3">
            ...
            <button
              ...
              className="w-12 h-12 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center text-white hover:text-warm-300 hover:bg-white/20 transition-all duration-300 group"
              title={showDetails ? '隐藏详情 (按I键)' : '显示详情 (按I键)'}
            >
          ...
          <div className="absolute top-6 left-6 z-10">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2 text-white text-xs">
